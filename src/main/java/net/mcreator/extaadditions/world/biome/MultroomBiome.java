...
import net.mcreator.extaadditions.block.RedmyceliumBlock;
...
public class MultroomBiome extends ExtaAdditionsModElements.ModElement {
	public static Biome biome;
	public MultroomBiome(ExtaAdditionsModElements instance) {
		super(instance, 89);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-26317).setWaterColor(-26164).setWaterFogColor(329011)
						.withSkyColor(-26317).withFoliageColor(-16737946).withGrassColor(-16724992)
						.setParticle(new ParticleEffectAmbience(SkybeamParticle.particle, 0.005f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(RedmyceliumBlock.block.getDefaultState(),
								RedDirtBlock.block.getDefaultState(), RedDirtBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(MushroomakeBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("exta_additions:multroom"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("multroom_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("multroom_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("multroom_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
