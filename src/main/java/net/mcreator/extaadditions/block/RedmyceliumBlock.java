...
public class RedmyceliumBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:redmycelium")
	public static final Block block = null;
	public RedmyceliumBlock(ExtaAdditionsModElements instance) {
		super(instance, 88);
	}
