...
public class BluewoodButtonBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_button")
	public static final Block block = null;
	public BluewoodButtonBlock(ExtaAdditionsModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("bluewood_button");
		}
