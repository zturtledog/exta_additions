...
public class RozenGlassBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:rozen_glass")
	public static final Block block = null;
	public RozenGlassBlock(ExtaAdditionsModElements instance) {
		super(instance, 30);
	}
