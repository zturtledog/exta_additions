...
public class MushroomceliusBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:mushroomcelius")
	public static final Block block = null;
	public MushroomceliusBlock(ExtaAdditionsModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mushroomcelius");
		}
