...
public class DuipyurWoodBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:duipyur_wood")
	public static final Block block = null;
	public DuipyurWoodBlock(ExtaAdditionsModElements instance) {
		super(instance, 92);
	}
