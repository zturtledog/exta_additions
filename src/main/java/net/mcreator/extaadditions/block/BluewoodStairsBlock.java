...
public class BluewoodStairsBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_stairs")
	public static final Block block = null;
	public BluewoodStairsBlock(ExtaAdditionsModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bluewood_stairs");
		}
