...
public class DuipyurLogBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:duipyur_log")
	public static final Block block = null;
	public DuipyurLogBlock(ExtaAdditionsModElements instance) {
		super(instance, 93);
	}
