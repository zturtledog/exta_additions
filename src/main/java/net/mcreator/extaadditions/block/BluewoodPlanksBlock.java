...
public class BluewoodPlanksBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_planks")
	public static final Block block = null;
	public BluewoodPlanksBlock(ExtaAdditionsModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bluewood_planks");
		}
