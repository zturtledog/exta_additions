...
public class BluewoodLeavesBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_leaves")
	public static final Block block = null;
	public BluewoodLeavesBlock(ExtaAdditionsModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("bluewood_leaves");
		}
