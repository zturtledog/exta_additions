...
public class DuipyurButtonBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:duipyur_button")
	public static final Block block = null;
	public DuipyurButtonBlock(ExtaAdditionsModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("duipyur_button");
		}
