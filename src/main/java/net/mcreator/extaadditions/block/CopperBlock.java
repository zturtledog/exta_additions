...
public class CopperBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:copper")
	public static final Block block = null;
	public CopperBlock(ExtaAdditionsModElements instance) {
		super(instance, 112);
	}
