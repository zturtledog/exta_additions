...
import net.mcreator.extaadditions.procedures.AssemblerUpdateTickProcedure;
import net.mcreator.extaadditions.gui.AssemblerGUIGui;
...
public class AssemblerBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:assembler")
	public static final Block block = null;
	@ObjectHolder("exta_additions:assembler")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public AssemblerBlock(ExtaAdditionsModElements instance) {
		super(instance, 76);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("assembler"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				AssemblerUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
