...
public class RedDirtBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:red_dirt")
	public static final Block block = null;
	public RedDirtBlock(ExtaAdditionsModElements instance) {
		super(instance, 89);
	}
