...
public class MushroomskirtBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:mushroomskirt")
	public static final Block block = null;
	public MushroomskirtBlock(ExtaAdditionsModElements instance) {
		super(instance, 87);
	}
