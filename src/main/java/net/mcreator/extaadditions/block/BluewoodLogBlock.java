...
public class BluewoodLogBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_log")
	public static final Block block = null;
	public BluewoodLogBlock(ExtaAdditionsModElements instance) {
		super(instance, 40);
	}
