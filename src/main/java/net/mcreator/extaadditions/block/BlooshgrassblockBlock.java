...
public class BlooshgrassblockBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:blooshgrassblock")
	public static final Block block = null;
	public BlooshgrassblockBlock(ExtaAdditionsModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blooshgrassblock");
		}
