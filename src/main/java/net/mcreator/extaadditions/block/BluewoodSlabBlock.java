...
public class BluewoodSlabBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_slab")
	public static final Block block = null;
	public BluewoodSlabBlock(ExtaAdditionsModElements instance) {
		super(instance, 44);
	}
