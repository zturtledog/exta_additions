...
public class DuipyurFenceGateBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:duipyur_fence_gate")
	public static final Block block = null;
	public DuipyurFenceGateBlock(ExtaAdditionsModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("duipyur_fence_gate");
		}
