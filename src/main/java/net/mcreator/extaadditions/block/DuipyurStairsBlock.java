...
public class DuipyurStairsBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:duipyur_stairs")
	public static final Block block = null;
	public DuipyurStairsBlock(ExtaAdditionsModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("duipyur_stairs");
		}
