...
public class MushroomstemBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:mushroomstem")
	public static final Block block = null;
	public MushroomstemBlock(ExtaAdditionsModElements instance) {
		super(instance, 85);
	}
