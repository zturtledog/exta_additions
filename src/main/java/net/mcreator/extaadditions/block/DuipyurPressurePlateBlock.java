...
public class DuipyurPressurePlateBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:duipyur_pressure_plate")
	public static final Block block = null;
	public DuipyurPressurePlateBlock(ExtaAdditionsModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("duipyur_pressure_plate");
		}
