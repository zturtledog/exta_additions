...
public class BluewoodPressurePlateBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_pressure_plate")
	public static final Block block = null;
	public BluewoodPressurePlateBlock(ExtaAdditionsModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("bluewood_pressure_plate");
		}
