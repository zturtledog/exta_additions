...
import net.mcreator.extaadditions.procedures.ExtractorUpdateTickProcedure;
import net.mcreator.extaadditions.gui.ExtractorGUIGui;
...
public class ExtractorBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:extractor")
	public static final Block block = null;
	@ObjectHolder("exta_additions:extractor")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ExtractorBlock(ExtaAdditionsModElements instance) {
		super(instance, 80);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("extractor"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ExtractorUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Extractor");
					}
