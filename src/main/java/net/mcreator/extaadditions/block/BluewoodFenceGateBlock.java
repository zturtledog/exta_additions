...
public class BluewoodFenceGateBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_fence_gate")
	public static final Block block = null;
	public BluewoodFenceGateBlock(ExtaAdditionsModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("bluewood_fence_gate");
		}
