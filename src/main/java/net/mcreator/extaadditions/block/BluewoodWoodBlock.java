...
public class BluewoodWoodBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_wood")
	public static final Block block = null;
	public BluewoodWoodBlock(ExtaAdditionsModElements instance) {
		super(instance, 39);
	}
