...
public class BluewoodFenceBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:bluewood_fence")
	public static final Block block = null;
	public BluewoodFenceBlock(ExtaAdditionsModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("bluewood_fence");
		}
