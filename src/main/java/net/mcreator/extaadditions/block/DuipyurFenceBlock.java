...
public class DuipyurFenceBlock extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:duipyur_fence")
	public static final Block block = null;
	public DuipyurFenceBlock(ExtaAdditionsModElements instance) {
		super(instance, 98);
	}
