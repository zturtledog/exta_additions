...
public class CapacitorItem extends ExtaAdditionsModElements.ModElement {
	@ObjectHolder("exta_additions:capacitor")
	public static final Item block = null;
	public CapacitorItem(ExtaAdditionsModElements instance) {
		super(instance, 70);
	}
